...
<div className="p-4 sm:p-6 bg-gray-100">
  ...
  <div className="flex items-center mb-6">
    ...
    <h2 className="text-xl sm:text-2xl font-bold text-purple-700 ms-4 sm:ms-5 mb-3">
      Course Content
    </h2>
  </div>
    ...
    <div className="mb-8 bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 p-4">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-white">Course Preview</h3>
        </div>
      </div>
            ...
            <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="bg-black/50 backdrop-blur-sm rounded-lg p-3">
                  <h4 className="text-white font-semibold text-base sm:text-lg">{course.name}</h4>
...
<div
  className="flex flex-col sm:flex-row justify-between items-start sm:items-center cursor-pointer p-4 hover:bg-gray-50 transition-colors gap-y-2"
  onClick={() => toggleSection(moduleNumber)}
>
  {/* Left Section */}
  <div className="flex-1">
    <h3 className="font-semibold flex items-center space-x-3 text-base sm:text-lg">
    ...
    {module.description && (
      <p className="text-gray-600 text-sm mt-2 ml-7 sm:ml-8">{module.description}</p>
    )}
  </div>
  ...
  <div className="text-left sm:text-right sm:min-w-[120px]">
    ...
    {module.moduleDuration > 0 && (
      <span className="text-sm text-gray-600 block">
        duration <strong>{module.moduleDuration}</strong> h 
      </span>
    )}
  </div>
</div>
                ...
                {module.subModules.map((submodule, sModuleNumber) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-y-2">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          <span className="text-purple-500 font-bold">{sModuleNumber + 1}.</span>
                          <h4 className="font-semibold text-gray-800">{submodule.sModuleTitle}</h4>
                        </div>
